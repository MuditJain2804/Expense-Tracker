...
const AddCredit = ({setCreditName,setCreditDescription,setCreditAmount,setCreditDaysLeft}) => {
    ...
    function calculateDaysLeft(start, end){
        if(start && end ) {
            ...
            setCreditDaysLeft(differenceInDays)
        }
    }
  return (
    <div style={{position:"relative",height:"97vh"}}>
        <div style={{display:"flex", gap:"15px"}}>
            ...
            <div style={{fontSize:"20px"}}>Add credit</div>
        </div>
